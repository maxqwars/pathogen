...
const ReleaseBriefly = (props: IReleaseBrieflyProps) => {
  const { release } = props

  return (
    <div className={styles['release-briefly']}>
      <div className={styles['release-briefly__poster-container']}>
        <img className={styles['release-briefly__poster-image']} src={Placeholder} alt="" />
      </div>

      <div className={styles['release-briefly__actions']}>
        <button className={styles['release-briefly__action-button']}>
          <IonIcon icon={heart} />
        </button>
        <button className={styles['release-briefly__action-button']}>
          <IonIcon icon={share} />
